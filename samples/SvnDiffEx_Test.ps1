...
Invoke-Expression "$basedir\SvnDiffEx.ps1"
...
Invoke-Expression "$basedir\SvnDiffEx.ps1 $url $outDir"
...
Invoke-Expression "$basedir\SvnDiffEx.ps1 -Url $url -BeforeRev $beforeRev -AfterRev $afterRev -EnvPattern ""$envPattern"" -OutDir $outDir"
...
Invoke-Expression "$basedir\SvnDiffEx.ps1 $url $outDir -BeforeRev $beforeRev -AfterRev $afterRev"
